...
//import com.Cybersoft.Final_Capstone.payload.request.AdminAssignPromotionRequest;
...
//
//    /**
//     * Assign promotion to a specific user
//     * POST /admin/promotions/assign
//     *
//     * Admin can assign any promotion to any user
//     *
//     * @param request Contains userId and promotionCode
//     * @return Created UserPromotionDTO
//     */
//    @PostMapping("/promotions/assign")
//    public ResponseEntity<?> assignPromotionToUser(@Valid @RequestBody AdminAssignPromotionRequest request) {
//        UserPromotionDTO userPromotion = userPromotionService.assignPromotionToUser(
//                request.getUserId(),
//                request.getPromotionCode()
//        );
//        BaseResponse response = new BaseResponse();
//        response.setCode(201);
//        response.setMessage("Promotion assigned successfully");
