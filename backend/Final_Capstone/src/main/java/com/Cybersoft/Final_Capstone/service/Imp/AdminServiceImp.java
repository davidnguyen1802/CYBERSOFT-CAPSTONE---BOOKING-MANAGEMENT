...
public class AdminServiceImp implements AdminService {
    ...
    public void deleteProperty(Integer propertyId) {
        ...
        property.setStatus(deletedStatus);
    ...
    @Override
    public Page<PromotionDTO> getAllPromotions(String status, Pageable pageable) {
        Page<Promotion> promotions = promotionRepository.findAll(pageable);
        return promotions.map(this::toPromotionDTO);
    }

    @Override
    @Transactional
    public PromotionDTO changePromotionStatus(Integer promotionId, String statusName) {
        Promotion promotion = promotionRepository.findById(promotionId)
                .orElseThrow(() -> new DataNotFoundException("Promotion not found with id: " + promotionId));
